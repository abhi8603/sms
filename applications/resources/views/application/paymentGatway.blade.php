...
<body>
    ...
    margin-top: 55px;">
		 ...
		 <input type="hidden" name="merchant_id" value="{{app_config('pg_merchant_id','2')}}"/>
		 <input type="hidden" name="order_id" value="{{$paydata['transactionId']}}"/>
		 <input type="hidden" id="amt" name="amount" value="{{$paydata['amt']}}"/>
		 <input type="hidden" name="currency" value="INR"/>
		 <input type="hidden" name="redirect_url" value="<?php echo url('/')."/application/paymentResponse" ?>"/>
		 <input type="text" name="cancel_url" value="<?php echo url('/')."/application/paymentResponse" ?>"/>
		 ...
		 <input type="hidden" name="billing_tel" value="{{$paydata['stu_phone']}}"/>
		 <input type="hidden" name="billing_email" value="{{$paydata['email']}}"/>

		 <input type="hidden" name="delivery_name" value="{{$paydata['name']}}"/>
		 ...
		 <input type="hidden" name="delivery_tel" value="{{$paydata['stu_phone']}}"/>
