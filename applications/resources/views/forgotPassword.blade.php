                        ...
                        <div class="signUP-admin-left signIn-admin-left position-relative">
                            ...
                            <div class="signUP-admin-left__content">
                                <div class="text-capitalize mb-md-30 mb-15 d-flex align-items-center justify-content-md-start justify-content-center">
                                    <a class="wh-36 bg-primary text-white radius-md mr-10 content-center" href="index.html">Online</a>
                                    <span class="text-dark">Application</span>
                                </div>
                                <h1>St. Paul's Web Application</h1>
                                        ...
                                        <div class="card border-0">
                                            <div class="card-header border-0  pb-md-15 pb-10 pt-md-20 pt-10 ">
                                                <div class="edit-profile__title">
                                                    <h6>Forgot <span class="color-primary">Password</span></h6>
                                                </div>
                                            </div>
                                            <div class="card-body">
											...
											@include('notification.notify')
                                                <div class="edit-profile__body">
													...
													<div class="form-group mb-20">
                                                        ...
                                                        <input type="mobile" class="form-control  @error('mobile') is-invalid @enderror" value="{{ old('mobile') }}" name="mobile" id="mobile" placeholder="mobile">
														@error('mobile')
                                   						  <span class="invalid-feedback" role="alert">
                                  					       <strong>{{ $message }}</strong>
                                  						   </span>
