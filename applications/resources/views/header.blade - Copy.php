    ...
    <header class="header-top">
        <nav class="navbar navbar-light">
            <div class="navbar-left">
                ...
                <a class="navbar-brand" href="{{url('/home')}}"><img style="height:64px;" class="svg dark" src="<?php echo "https://cloud.stpaulscollege.co.in/".app_config('AppLogo'); ?>" alt="Logo"><img class="light" src="img/logo_white.png" alt="img"></a>
                    ...
                    <div class="strikingDash-top-menu position-relative">
						...
						<span data-feather="book" class="nav-icon"></span>                          
                            ...
                            <li class="has-subMenu">
                                ...
                                <ul class="subMenu">
								<li>
                                        <a class="" href="{{url('/application/instructions')}}">Instructions</a>
                                    </li>
                                    <li>
                                        <a class="" href="{{url('/application/select')}}">Apply</a>
                                    </li>
                                    <li>
