    ...
    OR Request::path()=='userlist')class="treeview active" @endif class="treeview">
     ...
     || menuAccess(Auth::user()->user_role,'14')==true || menuAccess(Auth::user()->user_role,'15')==true)
           ...
           <li @if(Request::path()=='subject/lession-planning') class="treeview active" @endif class="treeview">
			 ...
			 <li @if( Request::path()=='online/classes') class="treeview active" @endif class="treeview">
             <a href="#"><i class="fa fa-fw fa-book"></i> Online Classes
               <span class="pull-right-container">
                 <i class="fa fa-angle-left pull-right"></i>
               </span>
             </a>
             ...
             @if(menuAccess(Auth::user()->user_role,'79')== true )
               <li @if(Request::path()== 'online/classes') class="active" @endif ><a href="{{url('online/classes')}}"><i class="fa fa-circle-o"></i>Online Classes</a></li>
             @endif
             </ul>
...
@endif
    ...
    @if(menuAccess(Auth::user()->user_role,'1015')== true || menuAccess(Auth::user()->user_role,'26')==true
     ...
     || menuAccess(Auth::user()->user_role,'100')==true)
       ...
       <li @if(Request::path()=='student/category' OR Request::path()=='student/admission' OR Request::path()=='student/studentlist'
          ...
          OR Request::path()== 'student/CharacterCertificate' OR Request::path()=='student/CurricularCertificate'  OR Request::path()==  'student/trialCertificate')
    class="treeview active" @endif class="treeview">
        <a href="#">
  ...
  @if(menuAccess(Auth::user()->user_role,'26')== true)
	   ...
	   @if(menuAccess(Auth::user()->user_role,'96')== true)
        <li @if(Request::path()== 'student/CurricularCertificate')class="active" @endif><a href="{{url('student/CurricularCertificate')}}"><i class="fa fa-circle-o"></i>Curricular Certificate</a></li>
        @endif
        @if(menuAccess(Auth::user()->user_role,'96')== true)
        ...
        @if(menuAccess(Auth::user()->user_role,'72')== true)
         ...
         @endif
          ...
          <li @if(Request::path()=='feedback')class="treeview active" @endif class="treeview">
            ...
            <ul class="treeview-menu">
              <li @if(Request::path()== 'feedback')class="active" @endif><a href="{{url('student/promotion')}}"><i class="fa fa-circle-o"></i>Promote Student</a></li>
             </ul>
           </li>
           @endif
  ...
  @if(menuAccess(Auth::user()->user_role,'1019')== true || menuAccess(Auth::user()->user_role,'115')==true
     ...
     || menuAccess(Auth::user()->user_role,'122')==true)
         <li @if(Request::path()=='Exam/exam_list' OR Request::path()=='Exam/exam_schedule_list' OR Request::path()=='Exam/mark_grade' OR Request::path()=='Exam/mark_register' 
			 OR Request::path()=='Exam/final_result/print/individual' OR Request::path()=='Exam/final_result/print' OR Request::path()=='Exam/marksSubmit/report'
    OR Request::path()=='Exam/student_exam_report' OR Request::path()=='Exam/final_result/bunch' OR Request::path()=='Exam/report' OR Request::path()=='Exam/bunch/report' OR Request::path()=='Exam/Finalreport' OR Request::path()=='Exam/final_result' OR Request::path()=='Exam/add_exam_schedule' OR Request::path()=='Exam/monthly/mark/save' OR Request::path()=='Exam/personality_traits' OR Request::path()=='Exam/monthly/mark/register' OR Request::path()=='Exam/annual/Finalreport' OR Request::path()=='Exam/create_mark_register')class="treeview active" @endif class="treeview">
         <a href="#">
         ...
         OR Request::path()=='Exam/Finalreport' OR Request::path()=='Exam/annual/Finalreport' OR Request::path()=='Exam/student_exam_report' OR Request::path()=='Exam/marksSubmit/report'
         )class="treeview active" @endif class="treeview">
           ...
           <ul class="treeview-menu"> 
            ...
            @endif
			     @if(menuAccess(Auth::user()->user_role,'121')== true)
             <li @if(Request::path()== 'Exam/marksSubmit/report')class="active" @endif><a href="{{url('Exam/marksSubmit/report')}}"><i class="fa fa-circle-o"></i>Marks Submit Report</a></li>
           @endif
           </ul>
         </li>

         <li @if(Request::path()=='Exam/final_result' OR Request::path()=='Exam/final_result/print/individual' OR Request::path()=='Exam/final_result/print' OR Request::path()=='Exam/final_result/bunch'
         )class="treeview active" @endif class="treeview">
        ...
        <li @if(Request::path()== 'Exam/final_result')class="active" @endif><a href="{{url('Exam/final_result')}}"><i class="fa fa-circle-o"></i>Final Result (individual)</a></li>
        @endif
			           @if(menuAccess(Auth::user()->user_role,'122')== true)
        <li @if(Request::path()== 'Exam/final_result/bunch')class="active" @endif><a href="{{url('Exam/final_result/bunch')}}"><i class="fa fa-circle-o"></i>Final Result (Bunch)</a></li>
        @endif
			     @if(menuAccess(Auth::user()->user_role,'122')== true)
        <li @if(Request::path()== 'Exam/final_result/print')class="active" @endif><a href="{{url('Exam/final_result/print')}}"><i class="fa fa-circle-o"></i>Print Result (Back)</a></li>
        @endif
			   @if(menuAccess(Auth::user()->user_role,'122')== true)
        <li @if(Request::path()== 'Exam/final_result/print/individual')class="active" @endif><a href="{{url('Exam/final_result/print/individual')}}"><i class="fa fa-circle-o"></i>Final Result (Print Individual)</a></li>
        @endif
		
					     @if(menuAccess(Auth::user()->user_role,'122')== true)
        <li @if(Request::path()== 'Exam/final_result/print')class="active" @endif><a href="{{url('search/student/card')}}"><i class="fa fa-circle-o"></i>Print Result (Front)</a></li>
        @endif

			   	     @if(menuAccess(Auth::user()->user_role,'122')== true)
        <li @if(Request::path()== 'search/report/card/particular')class="active" @endif><a href="{{url('search/report/card/particular')}}"><i class="fa fa-circle-o"></i>Print Result (New)</a></li>
        @endif
  @if(menuAccess(Auth::user()->user_role,'122')== true)
        <li @if(Request::path()== 'Exam/result/release/')class="active" @endif><a href="{{url('Exam/result/release/2020-2021')}}"><i class="fa fa-circle-o"></i>Result Release</a></li>
        @endif
