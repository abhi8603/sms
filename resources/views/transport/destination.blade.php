              ...
              <div class="row">
                <div class="col-md-5">
                  ...
                  <div class="box box-primary">
                           <div class="box-header with-border">
                             <h3 class="box-title">Add Destination and Fee</h3>
                           </div>
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('transport/destination/add')}}">
                          <div class="box-body">
                            <div class="form-group">
                              ...
                              @foreach($routes as $vehicles)
                                  <option value="{{$vehicles->id}}">{{$vehicles->routecode}} ({{$vehicles->vehicleno}})</option>
                                  @endforeach
                           </select>
                         </div>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="ad1"  name="pickanddrop" value="{{ old('pickanddrop') }}" placeholder="Pick up & Drop" required>
                          </div>
                ...
                <!-- /.form group -->
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="amount"  name="amount" value="{{ old('amount') }}" placeholder="Amount" required>
                          </div>
                          <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body">
                      <table id="example" class="table table-striped table-bordered display " style="width:100%">
                        ...
                        <tr>
                          <td><?php echo $i; ?></td>
                          <td>{{$destination->routecode}}</td>
                          <td>{{$destination->pickanddrop}}</td>
                          <td>{{$destination->stoptime}}</td>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu" title="Action">
                            <li><a href="{{url('transport/destination/view/'.$destination->id)}}" title="Edit"><i  class="fa fa-eye" style="color: #897df8e6";></i></a></li>
                            <li><a class="tFileDelete" href="" id="{{$destination->id}}" title="Delete"><i class="fa fa-trash" style="color: red";></i></a></li>
    ...
    $this.val($this.val().replace(/[^\d.]/g, ''));
            ...
            $(".tFileDelete").click(function (e) {
                ...
                bootbox.confirm("Are you sure?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/transport/destination/delete/" + id;
                    }
                });
            });
        });
