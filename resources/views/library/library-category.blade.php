              ...
              <div class="row">
                <div class="col-md-5">
                  ...
                  <div class="box box-primary">
                           ...
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('library/category/add')}}">
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="section_code" name="section_code" placeholder="Section Code" required>
                            </div>
                          </div>
                             <!-- /.box-body -->
                ...
                <div class="col-md-7">
                  <div class="box box-info">
                    <div class="box-header">
                      <h3 class="box-title">Library Category List</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                      <table id="example" class="table table-striped table-bordered display " style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{$library_category->category_name}}</td>
                              <td>{{$library_category->section_code}}</td>
                            ...
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu" role="menu" title="Action">
                                <li><a href="{{url('library/category/view/'.$library_category->id)}}" title="Edit"><i  class="fa fa-eye" style="color: #897df8e6";></i></a></li>
                                <li><a href="#" class="tFileDelete" id="{{$library_category->id}}" title="Delete"><i class="fa fa-trash" style="color: red";></i></a></li>
                              </ul>
                            </div>
                            </td>
                            </tr>
