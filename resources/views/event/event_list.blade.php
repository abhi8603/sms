...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="box box-default">
    ...
    <div class="box-header">
      <h3 class="box-title">Event List </h3><br><br>
       <a href="{{url('add/event')}}" class="btn btn-info" role="button">Add Event</a><br>
    <div class="col-md-12">
<div class="card">
  <div class="card-body">
             ...
             <table id="basic-datatables" class="table-bordered  t table-hover dataTable no-footer" role="grid" aria-describedby="basic-datatables_info">
              ...
              <tbody>
               ...
               <tr role="row" class="odd">
                ...
                <td>
                    <a href="{{url('update/'.md5($event['id']))}}" class="btn btn-info" role="button">Update</a>
                </td> 
                <td>
        ...
        $(document).ready(function () {
            ...
            $(".complainDelete").click(function (e) {
                ...
                bootbox.confirm("Do You Want To Delete Event!!?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/delete/" + id;
                    }
                });
            });
