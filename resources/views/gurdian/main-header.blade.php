...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{url('parentwelcome')}}" class="logo">
      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              ...
              <span class="label label-warning"><?php echo count(getNotification()); ?></span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have <?php echo count(getNotification()); ?> notifications</li>
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      ...
                      <hr style="margin: 3px;">
                      <span><?php echo $value->discription; ?></span>
                        <p><small><i class="fa fa-clock-o"></i>  <?php echo date("d-m-Y H:i:s", strtotime($value->created_at) ); ?></small></p>
                    </a>
                  </li>
                <?php } ?>
          ...
          <li class="dropdown user user-menu">
            ...
            @if(empty(session()->get('wardregno')))
            <script type="text/javascript">
           window.location = "{{ url('parentwelcome') }}";//here double curly bracket
           </script>
            @endif
