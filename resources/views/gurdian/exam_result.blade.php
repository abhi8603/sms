                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control select2" id="class"   name="class" style="width: 100%;" required>
                                        <option value="" selected="selected">Please select Class</option>
                                          ...
                                          {
                                            ?>
                                            <option value="<?php echo $value->course ?>"><?php echo $value->course_name; ?></option>
...
<script>
  ...
  $('#overlay').show();
               ...
               ({
                   type: "POST",
                   url: _url + '/parents/ward/exam/result/get',
                   data: {exam_id:exam_id,accadmicyear:accadmicyear,course:course},
                   cache: false,
