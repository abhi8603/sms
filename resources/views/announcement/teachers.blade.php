    ...
    <div class="box box-default">
            ...
            <div class="box-body">
             ...
             <div class="box box-primary">
                           ...
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('announcement/teacher_msg')}}">
                          <div class="box-body">
                           <div class="row" >
                                <div class="col-md-6">
                              <label class="">Announcement For</label>
                              ...
                              <option value="Select Degignation">Select Degignation</option>
                             </select>
                               </div>
                        </div>
                       <br> <div class="row form-group" id="deg" style="display: none;">
                         <div class="col-md-6">                              
                                <div class="form-group">
                                  <label>Degination :</label>
                                   <select id="degs" onchange="ancd()" name="desi" class="form-control select2" style="width:100%">
                              <option>Select Degignation </option>

                              @foreach($deg as $d)
                              <option value="{{$d->id}}">{{$d->degination}}</option>
                              @endforeach
                            </select>
                             </div>
                           </div>
