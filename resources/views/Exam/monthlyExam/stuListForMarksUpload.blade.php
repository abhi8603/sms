              ...
              <!--  <th>Max. Marks</th>  --->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$value->roll_no}}</td>
                <!--    <td>{{$exam_details[0]->fullmarks}}</td> -->
                    <td><input type="text" <?php if($submit_status==1){echo "readonly";} ?>
                      class="mark form-control" <?php if(isset($value->marks)){echo "readonly";} ?>
...
<script src="{{ URL::asset('assets/bower_components/jquery/dist/bootbox.min.js') }}"></script>
        ...
        $(document).ready(function(){
          ...
          $(".download").on("click",function(e){
            ...
            var month=$("#month").val();
            var _url = $("#_url").val();
            window.location.href = _url + "/Exam/marks/download/subjectwise/monthly/" + subject+"/"+cid+"/"+bid+"/"+academic_year+"/"+exam_id+"/"+month;
          });
       ...
       alert(msg);
          ...
          $(".mark").dblclick(function(){
            ...
            //  alert(data);exit;
              ...
              ({
                  type: "POST",
                  url: _url + '/Exam/monthly/mark/save',
                  data: {data:data,month:month,max_marks:max_marks,marks:marks,course:cid,batch:bid,academic_year:session,exam_id:$("#exam_id").val()},
                  cache: false,
                  success: function ( data ) {
                  //  alert(data);exit;
