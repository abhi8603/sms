...
<!-- Content Wrapper. Contains page content -->
 ...
 <div class="box box-primary" id="showresult" style="display:none;">
  ...
  <a class="btn btn-warning" style="float: right;" id="result_download">Download</a>
                         </div>
                          <div class="box-body">
         ...
         $(document).ready(function () {
           ...
           //var examname=$("#exam option:selected").text();
                ...
                bootbox.confirm("Are you sure?", function (result) {
                                  ...
                                  if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/Exam/download/result/" + cid+"/"+btoa(reg_no)+"/"+session+"/"+batch+"/"+exam;
                    }
           ...
           /*    $.ajax
               ({
                   type: "GET",
                   url: _url + '/Exam/download/result',
                   data: {session: session,reg_no:reg_no,cid:cid,batch:batch,exam:exam},
                   cache: false,
                   success: function ( data ) {
                   alert(data);
                    // window.location(_url+'/assets/result/hello world.xlsx');
