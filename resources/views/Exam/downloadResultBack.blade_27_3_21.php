...
$firstTotalP=0;$secondTotalP=0;$monthlyTotalP=0; $annualTotalP=0;$grandTotalP=0;$x=0;
  ...
  <?php $grandTotal=0; $gradepoint=0;$gradesubs=0;$gradesubstotal=0;?>
  ...
  //        echo "yy" .$gradesubstotal;
    ...
    //   echo $gradesubs." | ".$gradesubstotal;//exit;
...
<div class="col-md-12">
<span style="font-size:6px;margin-top: -10px;">Grade A = 80 % TO 100% , B = 60% TO 79%
...
<div class="row" style="display:flex;padding: 5px;">
<div class="col-md-12">
<h4 style="font-size: 11px;margin-top: -5px;">FINAL RESULT :  <span><?php if($fr==0){echo "PASS and Promoted to Class ".$nextClass;}else{echo "Promoted to Class ".$nextClass;};  ?> </span></h4>
