  ...
  <?php //print_r($firstTermMarks); ?>
    <tr>
      ...
      <td><?php if(isset($monthlyMarks)){
        echo $monthlyMarks[0]->marks=="0" || $monthlyMarks[0]->marks=="" ?"-":ceil($monthlyMarks[0]->marks);//exit;
  ...
  //        echo "yy" .$gradesubstotal;
      ...
      <td><?php if(isset($secondTermMarks)){
        ...
        if($secondTermMarks->marks=="A"){
          ...
          $ecnt++;
        }elseif($secondTermMarks->marks=="F"){
          $fcnt++;
        }
      ...
      <td><?php if(isset($monthlyMarks)){
        if(!$isGraded){
        echo $monthlyMarks[0]->marks=="0" || $monthlyMarks[0]->marks==""?"-":(int)ceil($monthlyMarks[0]->marks*20/100);
       ...
       $monthly=$monthlyMarks[0]->marks=="0" || $monthlyMarks[0]->marks=="" || $monthlyMarks[0]->marks==null ? "-" : $monthlyMarks[0]->marks;
      // echo"fff ". $monthly;
      ...
      if($monthly=="A"){
        ...
        $dcnt++;
      }elseif ($secondTermMarks=="E") {
        $ecnt++;
      }elseif($secondTermMarks=="F"){
        $fcnt++;
      }
      ...
      <td><?php if(isset($annualTermMarks)){
        ...
        $annualTotalP+=(int)$annualTermMarks->marks*50/100;
          ...
          if($annualTermMarks->marks=="A"){
            ...
            $ecnt++;
          }elseif($annualTermMarks->marks=="F"){
            $fcnt++;
          }
      ...
      //   echo $acnt."|".$bcnt."|".$ccnt."|".$dcnt."|".$fcnt;exit;
      if(($acnt+$bcnt+$ccnt+$dcnt+$ecnt+$fcnt)==0){
        echo "-";
      }else{
