  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Fee Sub Category Fine</li>
      </ol>
    </section>
          ...
          <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">Fee Sub Category Fine </a></li>
                          ...
                          <div class="box-body">
                            <table id="example" class="table table-striped table-bordered">
                              ...
                              <tr>
                                ...
                                <td>{{$fee_subcategory->fee_category_name}}</td>
                                <td>{{$fee_subcategory->sub_category}}</td>
                                @if($fee_subcategory->type=='%')
                                    <td>Percentage</td>
                                @else
                                    <td>Amount</td>
                                @endif
                                <td>{{$fee_subcategory->fine_amt}}</td>
                                <td>{{$fee_subcategory->fine_type}}</td>
                                <td>{{$fee_subcategory->months}}</td>
                              ...
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu" title="Action">
                                  <li style="display:none;"><a href="{{url('finance/Fee-subCategory-fine/update/'.Crypt::encrypt($fee_subcategory->id))}}" title="Edit"><i  class="fa fa-eye" style="color: #897df8e6";></i></a></li>
                                  <li><a href="#" class="tFileDelete" id="{{Crypt::encrypt($fee_subcategory->id)}}" title="Delete"><i class="fa fa-trash" style="color: red";></i></a></li>
                                  <li><a href="{{url('finance/Fee-subCategory-fine/update-status/'.$fee_subcategory->status.'/'.Crypt::encrypt($fee_subcategory->fee_category).'/'.Crypt::encrypt($fee_subcategory->fee_subcategory))}}" title="Update Status"><i class="<?php if($fee_subcategory->status==1) echo "fa fa-thumbs-down"; else echo "fa fa-thumbs-up"; ?>" style="color: red";></i></a></li>
                                </ul>
                              </div>
                              </td>
        ...
        $(document).ready(function () {
            ...
            $(".tFileDelete").click(function (e) {
                ...
                bootbox.confirm("Are you sure?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/finance/Fee-Sub-Category-fine/delete/" + id;
                    }
                });
            });
