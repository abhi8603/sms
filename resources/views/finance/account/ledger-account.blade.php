                ...
                <div class="col-md-12">
                  <div class="box box-primary">
                    ...
                    <div class="form-group">
                      <div class="col-md-3">
                      <label for="exampleInputEmail1">Ledger Account</label>
                      <select class="form-control select2" name="voucherhead" style="width: 100%;">
                          <option value="0" selected="selected">Please select</option>
                          <?php foreach ($ledger_acc as $ledger_acc): ?>
                              <option value="{{$ledger_acc->account_name}}">{{$ledger_acc->account_name}}</option>
                          <?php endforeach; ?>
                   </select>
                 </div>
               </div>
