              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="box box-primary">
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('finance/account/voucher/list/postsearch')}}">
                          <div class="box-body">
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <div class="input-group date">
                             ...
                             <input type="text" class="form-control pull-right dob" value="{{ old('dob') }}" id="dob" name="from">
                            </div>                                               <!-- /.input group -->
                          </div>
                       ...
                       <div class="form-group col-md-3">
                                       ...
                                       <div class="input-group date">
                                         ...
                                         <input type="text" class="form-control pull-right dob" value="{{ old('dob') }}" id="dob" name="to">
                                       </div>
                                       <!-- /.input group -->
                                     </div>
                    <div class="form-group">
                      <div class="col-md-3">
                      <label for="exampleInputEmail1">Voucher Head</label>
                      <select class="form-control select2" name="voucherhead" style="width: 100%;">
               ...
               <div class="form-group">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$voucherlist->ledger_acc}}</td>
                      <td>{{$voucherlist->cr}}</td>
                      <td>{{$voucherlist->dr}}</td>
                      <td>{{$voucherlist->payment_mode}}</td>
                      <td>{{$voucherlist->narration}}</td>
                      <td><a href="{{url('finance/account/voucher/view/'.$voucherlist->voucher_no)}}" title="View"><i  class="fa fa-eye" style="color: #897df8e6";></i></a></td>
                    </tr>
                    @endforeach
                </tbody>
