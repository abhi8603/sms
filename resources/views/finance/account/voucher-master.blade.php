              ...
              <div class="row">
                <div class="col-md-5">
                  ...
                  <div class="box box-primary">
                           <div class="box-header with-border">
                             <h3 class="box-title">Add Voucher Master</h3>
                           </div>
                           <!-- /.box-header -->
                           <!-- form start -->
                          ...
                          <div class="box-body">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="voucher_master" name="voucher_master" placeholder="Voucher Master" required>
                            </div>
                            <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body">
                      <table id="example" class="table table-striped table-bordered display " style="width:100%">
                        ...
                        <tbody>
                            @php $i=0; @endphp
                            @foreach($voucher_master as $voucher_master)
                              @php $i++; @endphp
                            <tr>
                              <td>@php echo $i; @endphp</td>
                              <td>{{$voucher_master->voucher_master}}</td>
                              <td>{{$voucher_master->crdr}}</td>
                              <td>
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu" role="menu" title="Action">
                                <li><a href="{{url('finance/account/voucher-master/view/'.$voucher_master->id)}}" title="Edit"><i  class="fa fa-eye" style="color: #897df8e6";></i></a></li>
                                <li><a href="#" class="tFileDelete" id="{{$voucher_master->id}}" title="Delete"><i class="fa fa-trash" style="color: red";></i></a></li>
                              </ul>
                            </div>
                            </td>
                            </tr>
        ...
        $(document).ready(function () {
            ...
            $(".tFileDelete").click(function (e) {
                ...
                bootbox.confirm("Are you sure?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/finance/account/voucher-master/delete/" + id;
                    }
                });
            });
