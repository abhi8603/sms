  ...
  <div class="content-wrapper">
    ...
    <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Employee Details Update</h3>
           ...
           <form role="form" method="post" enctype="multipart/form-data" action="{{url('hr/employee/admin_update_profile')}}">
                             <div class="box-header with-border">
...
<div class="form-group col-md-4">
 ...
 <div class="tab-pane" id="tab_2">
  <div class="box box-info">
          ...
          <div class="col-md-12">
        <div class="col-md-6"> 
           <form role="form" method="post" enctype="multipart/form-data" action="{{url('hr/employee/admin_update_profile_image')}}">
         
              <div class="form-group">
              <input type="hidden" class="form-control" id="empcode" value="{{$users->empcode OR ''}}" name="empcode" placeholder="Employee Code" readonly>
 ...
 <div class="tab-pane" id="tab_3">
  <div class="box box-warning">
          ...
          <div class="col-md-12">
        <div class="col-md-6"> 
           <form role="form" method="post" enctype="multipart/form-data" action="{{url('hr/employee/admin_update_password')}}">
             <div class="form-group">
