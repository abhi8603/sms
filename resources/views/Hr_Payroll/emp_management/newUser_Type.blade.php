              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="box box-primary">
                           ...
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" name="adduser" id="adduser" enctype="multipart/form-data" action="{{url('hr/add-userType-new')}}">
                          <div class="box-body">
                    ...
                    <div class="box-body">
                      <table id="example" class="table table-striped table-bordered display nowrap" style="width:100%">
                        ...
                        <tr>
                          ...
                          <td data-label="User Type">{{$value->usertype}}</td>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu" title="Action">
                            <li><a href="{{url('hr/employee/set-roles/'.$value->id)}}" title="Edit"><i  class="fa fa-eye" style="color: #897df8e6";></i>Edit</a></li>
                              <li><a href="{{url('hr/employee/set-roles/'.$value->id)}}" title="Set Roles"><i class="fa fa-bars" style="color: red";></i>Set Roles</a></li>
							  <li><a href="{{url('hr/delete/'.$value->id)}}" title="delete"><i class="fa fa-trash" style="color: red";></i>Delete</a></li>
