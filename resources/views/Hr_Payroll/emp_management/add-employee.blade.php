...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                           ...
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('hr/employee/add')}}">
                             <div class="box-header with-border">
              ...
              <div class="row">
                <div class="form-group col-md-4">
                 ...
                 <input type="text" class="form-control" id="empcode" value="{{$empcode}}" name="empcode" placeholder="Employee Code">
               </div>
               <div class="form-group col-md-4">
                               ...
                               <div class="input-group date">
                                 ...
                                 <input type="text" class="form-control pull-right" id="startdate" name="joiningdate">
                               </div>
                               <!-- /.input group -->
                             </div>
               <div class="form-group col-md-4">
                 ...
                 <select class="form-control select2" name="department" style="width: 100%;" required>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="totalexperience" name="totalexperience" placeholder="Total Experience" required>
                  </div>
               ...
               <div class="form-group col-md-4">
                 ...
                 <input type="text" class="form-control" name="emppassword" placeholder="Employee Password" required>
               </div>
              </div>
              ...
              <div class="row">
               ...
               <div class="form-group col-md-4">
                 ...
                 <input type="text" class="form-control" id="InstitutionName" name="panno" placeholder="PAN Number">
               </div>


            <div class="form-group col-md-4">
              <label for="exampleInputEmail1">PF Number</label>
              <input type="text" class="form-control" id="InstitutionName" name="pf" placeholder="PF Number">
            </div>
            <div class="form-group col-md-4">
              <label for="exampleInputEmail1">ESI</label>
              <input type="text" class="form-control" id="InstitutionName" name="esi" placeholder="ESI">
            </div>
            <div class="form-group col-md-4">
   ...
   <div class="form-group col-md-4">
     ...
     <input type="text" class="form-control" id="Aadharno" name="aadharno" placeholder="Aadhar Number">
   </div>
     </div>
              </div>
              <div class="box-header with-border">
...
<div class="row">
  <div class="form-group col-md-5">
    ...
    <textarea class="form-control" id="permanentaddress" rows="3" name="permanentsddress" placeholder="Permanent Address" required></textarea>
  </div>
  ...
  <div class="form-group col-md-5">
    ...
    <textarea class="form-control" rows="3" id="presentaddress" name="persentddress" placeholder="Present Address" required></textarea>
  </div>
<div class="form-group col-md-4">
...
<div class="form-group col-md-4">
  ...
  <input type="text" class="form-control" id="Pin" placeholder="Pin" name="pin" onkeypress="return isNumber(event)"  required>
</div>
...
<div class="form-group col-md-4">
  ...
  <input type="text" class="form-control" id="states" name="state" placeholder="State" required>
</div>
<div class="form-group col-md-4">
  <label for="exampleInputEmail1">Phone<span style="color:red;"> *</span></label>
  <input type="text" class="form-control" id="Pin" placeholder="Phone" name="phone" onkeypress="return isNumber(event)"  required>
</div>
<div class="form-group col-md-4">
  <label for="exampleInputEmail1">Email<span style="color:red;"> *</span></label>
  <input type="email" class="form-control" id="Pin" placeholder="Email" name="email" required>
</div>
</div>
  </div>
</div>
