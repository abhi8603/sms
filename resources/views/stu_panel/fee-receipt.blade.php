...
<!-- Content Wrapper. Contains page content -->
              ...
              <div class="row">
                ...
                <small>{{date('dS F - Y')}}</small>
                 ...
                 <div class="form-group" style="width:400px;padding-bottom: 0px;" >
                     <h6 style="text-align: center;padding: 0px;text-decoration-line: underline;">An English Medium CBSE School from Class Nursury to XIIth.</h6>
                 </div>
  ...
  <label>@if($receipt_status=='1')<span style="color:green;">Paid</span> @else <span style="color:red;">Canceled</span>  @endif</label>
  </div>
  </div>
    </div>
