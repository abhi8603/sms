                ...
                <div class="box box-primary">
                         <div class="box-header with-border">
                          ...
                          <div class="col-md-3">
                            ...
                            <select class="form-control select2" id="batch" onchange="show()" name="batch" style="width: 100%;" required>
...
<script>
     ...
     function homeworklist()
     {
      ...
      $.ajax({
         type: "POST",
         url: _url + '/teacher/view_assignment',
        data: dataString,
        cache: false,
        success:function(data)
        {
          ...
          for(var i in data)
          {
            table.row.add( [
                    ...
                    '<div><input type="hidden" id="crs" value="'+data[i]['course']+'"><input type="hidden" id="btch" value="'+data[i]['batch']+'"><input type="hidden" id="subject" value="'+data[i]['subject']+'"><button type="button" id="ev" data-toggle="modal" data-target="#myModal" onclick="eval()" value="'+data[i]['id']+'"><i class="fa fa-bars"></i></button></div>'
 ...
 <script type="text/javascript">
   function eval()
   {
      ...
      var ds=cid+'&'+bid+'&'+sid+'&'+hid;
      
         
    window.location.href = _url + "/teacher/evaluate_assignment/"+ds;
