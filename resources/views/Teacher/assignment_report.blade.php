...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="box box-default">
           ...
           <h3 class="box-title">Assignment Report</h3>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="box box-primary">
                     ...
                     <div class="col-md-2">
                           <input type="button" value="Search" onclick="search()" class="btn btn-primary">
                     </div>
 ...
 <script type="text/javascript">
   function search()
   {
    var table =$('#wrk').DataTable();
      ...
      var date=$("#dob").val();
      var _url = $("#_url").val();
      var dataString='cid='+cid+'&bid='+bid+'&sub='+sub+'&date='+date;
      //alert(dataString);
      $.ajax({
         type: "POST",
         url: _url + '/teacher/evalution_report_list',
        data: dataString,
        cache: false,
        success:function(data)
        {
