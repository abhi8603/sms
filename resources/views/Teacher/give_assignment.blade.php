            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="box box-primary">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{url('teacher/add_assignment')}}">
                 <div class="row">
                   <div class="col-md-4">
                   ...
                   <div class="col-md-4">
                    <label>Assignment Date</label>
                      <div class="input-group date">
                                 ...
                                 <input type="text" class="form-control"  value="<?php echo date('d-m-Y'); ?>" name="assignment_date" required readonly>
                               </div>
                   </div>
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <div id="content-row">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" id="code_preview0" name="description" style="height: 300px; width: 100%;"></textarea>
                          </div>
                        </div>
                      </div>
                      <?php $content_row++; ?>
