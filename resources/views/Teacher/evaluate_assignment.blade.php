...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Evaluate Assignment List</li>
      </ol>
    </section>
  ...
  <div class="box box-default">
           ...
           <h3 class="box-title">Assignment Evaluate List</h3>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="box box-primary">
                         ...
                         <form role="form" method="post" enctype="multipart/form-data" action="{{url('teacher/evaluate_assignment_status')}}">
                         <input type="hidden" name="assignment" value="{{$h}}">
                           @foreach($result as $stu)
                            ...
                            <div class="col-sm-3" style="padding: 2%;">
                              ...
                              <br>
                            <input type="hidden" name="reg_no[]" value="{{$stu->reg_no}}" readonly="">
