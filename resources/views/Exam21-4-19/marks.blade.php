                ...
                for(var i in data)
                  {
                    ...
                    table.row.add( [
                    '<input type="text" name="reg_no[]" id="reg_no" style="width:70px;border:0"  value='+ data[i]['reg_no']+' readonly>',
                     ...
                     '<button type="button" onclick="get_result('+ data[i]['id']+')" Value="'+ data[i]['reg_no']+'"  class="btn btn-primary">View</button>'
