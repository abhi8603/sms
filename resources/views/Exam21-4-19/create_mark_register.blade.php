                         ...
                         <div class="box-header with-border">
                          ...
                          <div class="box-body">
                            <div class="col-md-3">
                                ...
                                <select class="form-control select2" id="exam"   name="exam_id" style="width: 100%;" required>
                ...
                for(var i in data)
                  {
                    ...
                    table.row.add( [
                    '<input type="text" name="reg_no[]" style="width:70px;border:0"  value='+ data[i]['reg_no']+' readonly>',
                     '<input type="text" name="roll_no[]" style="width:50px;border:0" value="1" readonly>',
                     '<input type="text" style="border:0;"  value='+ data[i]['stu_name']+' readonly><br><input type="hidden" name="name[]" value='+ data[i]['id']+' >',
                     '<input class="mark" type="text" style="width:50px;" id="m_grade" oninput="search_grade()" Value="0" name="marks[]" required >',

                     '<span class="changeButton" style="color:green;cursor:pointer;">Present </span>'
                    ] ).draw( false );
                  }
                $('#overlay').hide();
              }
