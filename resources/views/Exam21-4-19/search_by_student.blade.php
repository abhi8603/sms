                ...
                <div class="box box-primary">
                         <div class="box-header with-border">
						  ...
						  <div class="col-md-3">
                            ...
                            <select class="form-control select2" id="student" onchange="get_result()"  name="student" style="width: 100%;" required>
          ...
          var accadmicyear=$("#accadmicyear").val();
             ...
             if(data.length==""){
                        ...
                        for (var i in data) {
                          ...
                          $(list).append('<option value="' +vid +'">' + v1 + ' ' + v +'</option>');
    ...
    <script>
       $(document).ready(function () {
          ...
          var reg_no=$("#student").val();
               ...
               var _url = $("#_url").val();
               var dataString = 'student='+student+'&reg_no='+reg_no;
               $.ajax
               ({
                   type: "POST",
                   url: _url + '/Exam/mark_by_student_name/',
                   data: dataString,
                   cache: false,
                   success: function ( data ) {
