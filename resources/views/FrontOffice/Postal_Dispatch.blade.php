  ...
  <div class="content-wrapper">
    ...
    <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Add Postal Dispatch</h3>
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="box box-primary">
                           ...
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('FrontOffice/insert_postal_dispatch')}}">
                          <div class="box-body">
                              
                            <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">To Title<span style="color:red;"> *</span></label>
                             <input type="text" name="to_title" class="form-control" required="">
                      </div>
                       <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">Reference No</label>
                      ...
                      <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">Note</label>
                             <textarea name="note" class="form-control"></textarea>
                               ...
                               <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">From Title</label>
                             <input type="text" name="from_title" class="form-control">
                      </div>
                ...
                <div class="col-md-9">
                  <div class="box box-info">
                    <div class="box-header">
                      <h3 class="box-title">Postal Recive List</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
        ...
        $(document).ready(function () {
            ...
            $(".tFileDelete").click(function (e) {
                ...
                bootbox.confirm("Are you sure?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/FrontOffice/delete_postal_dispatch/" + id;
                    }
                });
            });
