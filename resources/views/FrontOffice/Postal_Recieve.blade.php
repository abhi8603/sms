              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="box box-primary">
                           ...
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('FrontOffice/insert_postal_recieve')}}">
                          <div class="box-body">
                              
                            <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">From Title<span style="color:red;"> *</span></label>
                      ...
                      <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">Note</label>
                             <textarea name="note" class="form-control"></textarea>
                               ...
                               <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">To Title</label>
                             <input type="text" name="to_title" class="form-control">
                      </div>
                           <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
        ...
        $(document).ready(function () {
            ...
            $(".tFileDelete").click(function (e) {
                ...
                bootbox.confirm("Are you sure?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/FrontOffice/delete_postal_recive/" + id;
                    }
                });
            });
