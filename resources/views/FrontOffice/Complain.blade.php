              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="box box-primary">
                           ...
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('FrontOffice/insert_complain')}}">
                          <div class="box-body">
                              
                            <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">Complain Type</label>
                             <select name="complain_type" class="form-control">
                             <option>Select</option>
                             @foreach($comp as $comp)
                             <option value="{{$comp->id}}">{{$comp->complain_type}}</option>
                             @endforeach
                            </select>
                      </div>
                       <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">Source</label>
                       ...
                       <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">Compain By</label><span style="color:red;"> *</span>
                      ...
                      <table id="example" class="table table-striped table-bordered display" style="width:100%">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu" title="Action">
                            ...
                            <li><a href="" class="tFileDelete" id="{{$c->id}}" title="Delete"><i class="fa fa-trash" style="color: red";></i></a></li>
                          </ul>
                        </div>
                        </td>
        ...
        $(document).ready(function () {
            ...
            $(".tFileDelete").click(function (e) {
                ...
                bootbox.confirm("Are you sure?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/FrontOffice/complain_delete/" + id;
                    }
                });
            });
