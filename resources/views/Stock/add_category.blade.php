              ...
              <div class="row">
                <div class="col-md-5">
                  ...
                  <div class="box box-primary">
                           ...
                           <!-- /.box-header -->
                           <!-- form start -->
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('stock/insert_item_category')}}">
                          <div class="box-body">
                                <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="control-label">Item Category <span style="color:red;"> *</span></label>
                              <input type="text" class="form-control" name="category_name" id="category_item" required autofocus>
                      </div>
                          <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                      ...
                      <table id="example" class="table table-striped table-bordered display" style="width:100%">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu" title="Action">
                            ...
                            <li><a href="" class="tFileDelete" id="{{$cat->id}}" title="Delete"><i class="fa fa-trash" style="color: red";></i></a></li>
                          </ul>
                        </div>
                        </td>
