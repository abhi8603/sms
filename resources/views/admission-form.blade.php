...
<body>
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <h3 style="color: #fff;text-align: center;margin-left: 400px;">Seventh Day Adventist School</h3>
      </li>
    </ul>
  </nav>
<br>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <input name="name" placeholder="Surname name father name" type="text" class="form-control" required/>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group">
                            <label class="control-label">2. Seeking Admission in Class  <span style="color:red;">*</span></label>
                            <input  name="class" placeholder=" Admission in Class" type="text" class="form-control" required/>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                <input name="dob" class="form-control" type="text" required/>
