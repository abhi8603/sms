...
@if(menuAccess(Auth::user()->user_role,'1022')== true || menuAccess(Auth::user()->user_role,'130')==true
  ...
  <!-- Event Menu -->
    ...
    OR Request::path()=='userlist')class="treeview active" @endif class="treeview">
         ...
         <ul class="treeview-menu">
         @if(menuAccess(Auth::user()->user_role,'72')== true)
          <li class="active"><a href="{{url('category')}}"><i class="fa fa-circle-o"></i>Category Wise Student Details</a></li>
          <li class="active"><a href="{{url('cast')}}"><i class="fa fa-circle-o"></i>Dynamic Cast Details</a></li>
         @endif
          </ul>
       </li>
      @endif
