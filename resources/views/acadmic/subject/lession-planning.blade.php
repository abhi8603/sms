                                    ...
                                    <div class="box-body">
                                      <div class="row">
                                        ...
                                        <label>Teaching method</label>
                                          <input type="text" class="form-control" id="t_method" placeholder="Teaching method">
                                        </div>
                                        <div class="col-xs-3">
                ...
                <div class="tab-pane" id="tab_2">
                  <div class="box-body">
                    ...
                    <div class="box box-info">
                                 <div class="box-header with-border">
                                   <h3 class="box-title">Lession Planning Report</h3>
                                 </div>
                       <div class="col-md-3">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Acadmic Year<span style="color:red;"> *</span></label>
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="box-footer">
                        ...
                        <div id="report_view" class="col-md-12">
  ...
  var cnt=0;
      $("#lessionlist tbody tr").each(function () {
        cnt++;
                ...
                topic.t_method=row.find('td:eq(5) input').val();
    ...
    var t_method=$("#t_method").val();
      ...
      if(fromdate !="" && topic != ""){
       tt.row.add( [
             ...
             '<input type="text" class="form-control"  name="hours" value="'+t_method+'" required></td>',
...
<script>
       $(document).ready(function () {
           /*For Details Loading*/
          $("#view").click(function(){
               var section = $("#batch_r").val();
               var subject = $("#subject_r").val();
             ...
             //  var dataString = 'eid=' + id;
               ...
               ({
                   type: "POST",
                   url: _url + '/subject/getlessionplanning',
                   data: {class_id:class_id,section:section,acadmic_year:acadmic_year,subject:subject},
                   cache: false,
                   success: function ( data ) {
