...
<!-- Content Wrapper. Contains page content -->
 ...
 <!--{{--
  <a href="{{url('sms/student/list/send/sms')}}"><button class="dt-button buttons-copy buttons-html5" type="button"><span> Students Send Sms</span></button></a>
  <a href="{{url('sms/emplyee/list/send/sms')}}"><button class="dt-button buttons-copy buttons-html5" type="button"><span>Employee Send Sms </span></button></a>
 --}}!-->
