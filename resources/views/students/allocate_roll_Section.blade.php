...
<script src="{{ URL::asset('assets/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
 ...
 <!--    <script>
       $(document).ready(function () {
          ...
          //     alert(id);
               ...
               var academicyear=$("#accadmicyear").val();
                ...
                var dataStringds=eid+'&'+bid+'&'+academicyear;
               alert(dataString);
              // window.location.href = _url + "/student/studenlist/" + dataString;
           });
   ...
   <script type="text/javascript">
     ...
     var eid=$("#courses").val();
     var academicyear=$("#accadmicyear").val();
     var ds=eid+'&'+academicyear;
     alert(ds);
     window.location.href = _url + "/student/studenlist/" + ds;
     }
   </script>
<script>
