  ...
  <div class="box box-default">
           ...
           <h3 class="box-title">Roll and Section Allocation</h3>
            ...
            <div class="box-tools pull-right">
              <a href=""> <button style="display: none;" type="button" class="btn btn-primary"></button></a>
          ...
          <form role="form" method="post" enctype="multipart/form-data" action="{{url('student/edit_roll_section')}}">
               ...
               ({
                   ...
                   var sp2=JSON.parse(sp[1]);
                    ...
                    for (var i = 0; i < sp1.length; i++) {
                      ...
                      cnt +='</select></td>';
                      cnt +='<td><input class="mark" type="text" value="'+sp1[i].roll_no+'" style="width:70px;"  name="roll_no[]" required ></td>';
                      cnt += '</tr>';
                  }
