  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Character Certificate</li>
      </ol>
    </section>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="box box-primary">
                           <form role="form" method="post" enctype="multipart/form-data" action="{{url('student/downloadCharacter')}}">
                          <div class="box-body">
                              <div class="col-md-4">
                ...
                <div class="col-md-12">
                  <div class="box box-info">
                    <div class="box-header">
                      <h3 class="box-title">Character Certificate Issue List</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
