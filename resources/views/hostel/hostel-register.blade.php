...
<!-- Content Wrapper. Contains page content -->
          ...
          <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">Hostel Register</a></li>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                                 <div class="box-header with-border">
                                   <h3 class="box-title">Hostel Register</h3>
                                 </div>
                                 <!-- /.box-header -->
                                 <!-- form start -->
                                 <form role="form" method="post" enctype="multipart/form-data" action="{{url('hostel/register/update')}}">
                                   <div class="box-body">
                                     <div class="col-md-12">
                                     <div class="form-group col-md-6">
                                       <label for="exampleInputEmail1">User Type<span style="color:red;"> *</span></label>
                                      <select id="utype" class="form-control select2" name="utype" style="width: 100%;">
 ...
 <label for="exampleInputEmail1" id="hostel"></label>
  ...
  <div class="form-group col-md-4">
      <label for="exampleInputEmail1">In/Out<span style="color:red;"> *</span></label>
      <select  id="openh" name="inout"class="form-control select2" style="width: 100%;" required>
      <option value="" selected="selected">Please Select</option>
                            ...
                            <table id="example" class="table table-striped table-bordered display" style="width:100%">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{$movement->usertype}}</td>
                                  <td>{{$movement->reg_no}}</td>
                                  <td>{{$movement->hostel}}</td>
                                  <td>{{$movement->floor_room}}</td>
                                  <td>{{$movement->out_date}} {{$movement->out_time}}</td>
                                  <td>{{$movement->in_date}} {{$movement->in_time}}</td>
                                  ...
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <li><a href="#" class="tFileDelete" id="{{$movement->id}}" title="Delete"><i class="fa fa-trash" style="color: red";></i></a></li>
                                      </ul>
                                    </div>
                                </td>
                                </tr>
          ...
          $("#student").change(function(){
            ...
            $(".tFileDelete").click(function (e) {
                ...
                bootbox.confirm("Are you sure?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/hostel/register/delete/" + id;
                    }
                });
            });
        });
...
$("#utype").change(function(){
       ...
       if(types=='student'){
          ...
          $("#emp").hide();
          $("#emp").fadeOut('slow');
          $("#emp_code").prop("selectedIndex", 0);
          $("#emp_code option:first").attr('selected','selected');
          ...
          $("#emp").fadeIn('slow');
            ...
            $("#student option:first").attr('selected','selected');
