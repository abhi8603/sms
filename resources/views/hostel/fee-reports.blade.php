...
<!-- Content Wrapper. Contains page content -->
                                   ...
                                   <div class="box-body">
                                     ...
                                     <div   class="form-group col-md-4">
                                      ...
                                      <div class="input-group date">
										...
										<div   class="form-group col-md-4">
                                       <label for="exampleInputEmail1">Paid List<span style="color:red;"> *</span></label>
                                      <select  id="openh" class="form-control select2" style="width: 100%;">
                              <option selected="selected">Please Select</option>
                              <option value="in">Paid List</option>
                              <option value="out">Due LIst</option>
 ...
 <a type="button" onClick='javascript:showTable();' id="check"  type="submit" class="btn btn-primary ">Go</a>
