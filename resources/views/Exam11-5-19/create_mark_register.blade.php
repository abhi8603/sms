...
<script>
      $(function () {
       ...
       //  alert(subject);
           var _url = $("#_url").val();
           var dataString = 'cid='+cid+"&bid="+bid+"&examid="+examname+"&subject="+subject;
           //alert(dataString);
           $.ajax({
            type:"post",
            ...
            cache: false,
             success: function ( data )
             {
              ...
              for (var e in exam_details){
                  fm=exam_details[e]['full_marks'];
                  pm=exam_details[e]['pass_marks'];
                //  alert(fm);
              }
                for(var i in data)
                  {
                    ...
                    '<input type="text" name="reg_no[]" style="border:0;background: transparent;text-align: left;"  value='+ data[i]['reg_no']+' readonly>',
                     '<input type="text" name="roll_no[]" style="border:0;background: transparent;text-align: left;" value="1" readonly>',
                     ...
                     '<input class="mark" type="text" style="background: transparent;text-align: left;" id="m_grade" onkeypress="return isNumberKey(event)"  value="0" name="marks[]" required >',
