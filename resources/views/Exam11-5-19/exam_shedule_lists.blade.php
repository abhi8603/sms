                  ...
                  //  var cnt="";
                    ...
                    /*  cnt += '<tr>';
                      ...
                      cnt += '</tr>';  */
                       ts.row.add( [
                                sp1[i].exam_name,
                                '<button type="button" onclick="myFunction('+sp1[i].id +')" class="btn btn-info" data-toggle="modal" data-target="#myModal"><i class="fa fa-eye"> View</i></button>'
                               ] ).draw( false);
                  }
                   // ts.find('tbody').empty().append(cnt);
