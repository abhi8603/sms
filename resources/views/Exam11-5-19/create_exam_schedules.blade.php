   ...
   $("#save").click(function(){
      ...
      var batch=$("#batch").val();
       ...
       $("#example tbody tr").each(function () {
                ...
                examdetails.fillmarks = row.find('td:eq(6) input').val();
                examdetails.passmark = row.find('td:eq(7) input').val();
                 ...
                 /*    var cnt="";
                  ...
                  // ts.columns([0]).visible(false);
                     ...
                     ts.row.add( [
                                ...
                                '<input type="number" name="full_marks[]" style="width:80px;" onkeypress="return isNumber(event)" style="background-color:transparent;"/>',
                                '<input type="number" name="passing_marks[]" style="width:70px;" onkeypress="return isNumber(event)" style="background-color:transparent;"/>'
                              ] ).draw( false);
